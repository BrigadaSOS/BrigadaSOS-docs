...
### Animebook 
Es un reproductor web que le permitirá reproducir vídeos, películas, animes, entre otras. Tiene compatibilidad con subtítulos, la opción de crear sus propias tarjetas Anki con un solo clic y por supuesto, al ser una página web, es compatible con [Yomichan](../configuration/Yomichan.mdx). En lo personal, Animebook es mi herramienta favorita para hacer inmersión porque es la más cómoda y sencilla en mi experiencia.
