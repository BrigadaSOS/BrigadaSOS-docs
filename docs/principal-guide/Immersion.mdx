...
<div class="text--center">
    <img src={AnkiCardExample} width="600"/><br/>
...
### Formato Brigada SOS
Mucha de las quejas principales con las tarjetas de solo vocabulario es que una palabra, al tener muchas definiciones, no sé sabe realmente cuál es la definición que uno debe recordar. Es por ello que estas tarjetas, contienen el **vocabulario** más el contexto que viene siendo dado por la **oración** en el frente. Mientras que el reverso contiene **definiciones**, **pronunciación**, **imágen**, **audio de la palabra** y **audio de la oración**.
...
* [Google Imagenes](https://images.google.com/), que le servirá para añadir rápidamente una imagen a la tarjeta en caso de que no tenga ninguna.
...
### Animebook 
Es un reproductor web que le permitirá reproducir vídeos, películas, animes, entre otras. Tiene compatibilidad con subtítulos, la opción de crear sus propias tarjetas Anki con un solo click y por supuesto, al ser una página web, es compatible con [Yomichan](../configuration/Yomichan.mdx). En lo personal, Animebook es mi herramienta favorita para hacer inmersión porque es la más cómoda y sencilla en mi experiencia.  
