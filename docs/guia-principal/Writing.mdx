...
![kanji](/img/main_guide/example_kana_kanji.webp)<small><i>Los tres sistemas de escritura japoneses en uso en un manga </i>(本好きの下剋上)</small>

## Kana

![kana](/img/main_guide/writing_kana.webp)
...
![kanji](/img/main_guide/kanji_table.webp)<small><i>Algunos kanji básicos que se enseñan a los japoneses en su primer año de escuela.</i></small>
...
![Componentes-Kanji](/img/main_guide/kanji_composition.webp)<small><i>Los radicales de 習: 白 y 羽</i></small>
...
![Evol](/img/main_guide/evolution.webp)<small><i>Formas primitivas y modernas de varios caracteres</i></small>
